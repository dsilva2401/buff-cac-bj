                            ...
                            <Wrapper paddingTop="1px">
                                ...
                                >
                                    <DataTable
                                        ...
                                        tableData={
                                            warrantyData!.mulberry!.coverages
                                        }
                                    />
                                    <Wrapper
                                        cursor="pointer"
                                    ...
                                    <Text fontSize="0.75rem">
                                        <p>
                                            To extend protection or file a
                                            claim, click the account activation
                                            link that was sent to your email
                                            from Mulberry. You can also reach
                                            out to Mulberry support{' '}
                                            <span
                                                style={{
                                                    color:
                                                        appTheme ||
