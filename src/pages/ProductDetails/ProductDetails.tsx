...
const ProductDetails: React.FC = () => {
                    ...
                    <Wrapper width="100%" direction="column">
                        ...
                        >
                            <AuthDrawer
                                ...
                                animated={
                                    !!mulberry &&
                                    moduleType === 'WARRANTY_MODULE'
                                }
                                onPersonalDetailshow={() =>
                                    setDisableModalDismiss(true)
                                }
                                showMulberryTerms={
                                    !!mulberry &&
                                    moduleType === 'WARRANTY_MODULE'
    ...
    const logo = useCallback(
        (image: string) => (
            <Image src={image} alt="brand-logo" maxWidth="110px" />
        ),
        []
    );
